...
class CurrentWeather
{
  ...
  public function getWeatherDataFromApi()
  {
    ...
    try {
      ...
      if ($json === false) {
        throw new Exception('Http request failed. Wrong city name!');
      }
    } catch (Exception $e) {
  ...
  public function storeWeatherData($res)
  {
    ...
    $dateCorrectedWithTimezone = intval($res['dt'], 10) + intval($res['timezone'], 10);
    // get time hour:minutes
    $this->time = date('H:i', $dateCorrectedWithTimezone);
